...
New-ItemProperty –Path "HKLM:\SOFTWARE\FSLogix\Profiles" -PropertyType Dword -Name DeleteLocalProfileWhenVHDShouldApply -value 1 -Force
New-ItemProperty –Path "HKLM:\SOFTWARE\FSLogix\Profiles" -PropertyType Dword -Name FlipFlopProfileDirectoryName -value 1 -Force
New-ItemProperty –Path "HKLM:\SOFTWARE\FSLogix\Profiles" -PropertyType Dword -Name OutlookCachedMode -value 0 -Force
New-ItemProperty –Path "HKLM:\SOFTWARE\FSLogix\Profiles" -PropertyType Dword -Name RemoveOrphanedOSTFilesOnLogoff -value 0 -Force
New-ItemProperty –Path "HKLM:\SOFTWARE\FSLogix\Profiles" -PropertyType Dword -Name IncludeOfficeFileCache -value 1 -Force
New-ItemProperty –Path "HKLM:\SOFTWARE\FSLogix\Profiles" -PropertyType Dword -Name IncludeOneDrive -value 0 -Force
New-ItemProperty –Path "HKLM:\SOFTWARE\FSLogix\Profiles" -PropertyType Dword -Name IncludeOutlook -value 0 -Force
New-ItemProperty –Path "HKLM:\SOFTWARE\FSLogix\Profiles" -PropertyType Dword -Name IncludeTeams -value 0 -Force
